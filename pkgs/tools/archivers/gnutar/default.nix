{ lib, stdenv, fetchurl, makeWrapper, autoreconfHook, acl, libintl }:
...
stdenv.mkDerivation rec {
  ...
  nativeBuildInputs = [ makeWrapper ] ++ lib.optional stdenv.isDarwin autoreconfHook;
  ...
  preFixup = ''
    wrapProgram $out/bin/tar \
      --append-flags "\''${GNUTAR_REPRODUCIBLE:+--mtime="@''$SOURCE_DATE_EPOCH" --owner=0 --group=0 --numeric-owner --sort=name}"
  '';
